...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    if (id) {
      dispatch(fetchServiceDetails(id)); // Call API on component mount
    }
  }, [id, dispatch]);
  ...
  const services = serviceObject?.services;

  const details = serviceDetails?.project;
  const whyChoseDescribe = details?.whyChoose;
  const faqs = details?.serviceFaq;
  const serviceOfferDescribe = details?.servicesOffered;
    ...
    <DetailRap>
      ...
      <div className="all-details containers">
        <div className="detail-left">
          <div className="all-left-uper-uper">
            <div className="upper-left-left">
              <img src="/images/image-1.jpeg" alt="service" />
            ...
            <div className="detail-right detail-right-desktop">
              ...
              >
                ...
                <h4>{generalObject?.sitePhone}</h4>
                <Link className="right-2-button" to="/contact">
                  Get a Call Back
      ...
      {faqs?.map((items, index) => (
        ...
        >
         ...
         <div style={{
          marginTop: "50px"
         }} className="detail-right detail-right-mobile">
              <div className="right-1">
                <h4>More Services</h4>
                {services?.map((items) => (
                  <div
