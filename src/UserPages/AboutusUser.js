...
const AboutusUser = () => {
  ...
  const handleClick = (id) => {
    if (id === 1) {
      navigate(`/users/aboutAboutSection`);
    } else if (id === 2) {
      navigate(`/users/aboutMissionSection`);
    } else if (id === 3) {
      navigate(`/users/aboutCounterSection`);
    } else if (id === 4) {
      navigate(`/users/aboutTeamsSection`);
    }
  };
  return (
    <DashRap>
      <div className="all-dash">
        <h2>Manage About Page Contents</h2>
